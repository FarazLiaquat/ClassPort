...
namespace ClassPort.Web.Areas.Identity;
...
public class StudentListController : BaseController<StudentListController>
{
    ...
    // GET: Identity/StudentLists/Details/5
    public async Task<IActionResult> Details(int? id)
    {
        ViewData["AreaTitle"] = areaTitle;
        _breadcrumbs.StartAtAction("Dashboard", "Index", "Home", new { Area = "Dashboard" })
            .ThenAction("Manage StudentList", "Index", "StudentLists", new { Area = "Identity" })
    ...
    // GET: Identity/StudentLists/Create
    ...
    // POST: Identity/StudentLists/Create
    ...
    public async Task<IActionResult> Create([Bind(createBindingFields)] StudentList studentList)
    {
        ...
        _breadcrumbs.StartAtAction("Dashboard", "Index", "Home", new { Area = "Dashboard" })
        .ThenAction("Manage StudentList", "Index", "StudentListsController", new { Area = "Identity" })
        .Then("Create StudentList");     
    ...
    // GET: Identity/StudentLists/Edit/5
    ...
    // POST: Identity/StudentLists/Edit/5
    // To protect from overposting attacks, enable the specific properties you want to bind to.
    // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
    [HttpPost]
    [ValidateAntiForgeryToken]
    ...
    // GET: Identity/StudentLists/Delete/5
    ...
    // POST: Identity/StudentLists/Delete/5
