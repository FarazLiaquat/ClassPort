...
public class StudentListController : BaseController<StudentListController>
{
    ...
    // GET: Teacher/StudentList/Details/5
    public async Task<IActionResult> Details(int? id)
    {
        ViewData["AreaTitle"] = areaTitle;
        _breadcrumbs.StartAtAction("Dashboard", "Index", "Home", new { Area = "Dashboard" })
            .ThenAction("Manage StudentList", "Index", "StudentList", new { Area = "Teacher" })
    ...
    // GET: Teacher/StudentList/Create
    ...
    // POST: Teacher/StudentList/Create
    ...
    public async Task<IActionResult> Create([Bind(createBindingFields)] StudentList studentList)
    {
        ...
        _breadcrumbs.StartAtAction("Dashboard", "Index", "Home", new { Area = "Dashboard" })
        .ThenAction("Manage StudentList", "Index", "StudentListController", new { Area = "Teacher" })
        .Then("Create StudentList");     
    ...
    // GET: Teacher/StudentList/Edit/5
    ...
    // POST: Teacher/StudentList/Edit/5
    // To protect from overposting attacks, enable the specific properties you want to bind to.
    // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
    [HttpPost]
    [ValidateAntiForgeryToken]
    ...
    // GET: Teacher/StudentList/Delete/5
    ...
    // POST: Teacher/StudentList/Delete/5
